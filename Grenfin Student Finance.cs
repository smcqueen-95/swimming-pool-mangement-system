...
{
    public partial class Grenfin_Student_Finance : Form
    {
        public Grenfin_Student_Finance()
        {
            InitializeComponent();
        }
        ...
        private void Grenfin_Student_Finance_Load(object sender, EventArgs e)
        {
            labelUser.Text = GLOBAL.userType;

            //populating the datagridview with swimmer's data
            MySqlCommand command = new MySqlCommand("SELECT * FROM `student_finance` WHERE `Swim Team/s`='Grenfin'");
