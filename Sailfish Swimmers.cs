...
{
    public partial class Sailfish_Swimmers : Form
    {
        ...
        {
            string query = "SELECT * FROM `swimmers` WHERE CONCAT(`ID`, `First Name`, `Last Name`, `Gender`, `Birth Date`, `Age`, `School`, `Medical`, `Swim Team/s`, `Swim Group`, `Parent/s Name`, `Parent/s Address`, `Parent/s Number`, `Parent Email`) like '%" + valueToSearch + "%' AND `Swim Team/s`= 'Sailfish'";
        ...
        private void Sailfish_Swimmers_Load(object sender, EventArgs e)
        {
            //populating the datagridview with swimmer's data
            MySqlCommand command = new MySqlCommand("SELECT * FROM `swimmers` WHERE `Swim Team/s`='Sailfish'");
